...
|------|--------|-------------|
| `components/CitySelector.tsx` | [ ] | Search/dropdown to pick a city |
| `components/SiteMap.tsx` | [ ] | Leaflet map with scored markers |
| `components/SiteDetailPanel.tsx` | [ ] | Zoning, climate, energy summary |
| `components/CropPlanChart.tsx` | [ ] | Bar/pie chart of crop mix allocations |
| `components/RoiDashboard.tsx` | [ ] | Revenue, costs, breakeven card |
| `components/IncidentFeed.tsx` | [ ] | Live agent incidents with resolve button |
