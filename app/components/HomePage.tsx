	...
	return (
		<div className="flex min-h-screen flex-col bg-slate-950 font-sans text-slate-100">
			...
			<div className="relative flex flex-1 flex-col lg:block lg:min-h-[calc(100vh-3.25rem)]">
				<div className="relative z-[1100] flex flex-col gap-4 p-4 lg:absolute lg:left-6 lg:top-6 lg:w-[min(100%-3rem,22rem)] lg:p-0">
				...
				<div className="relative z-0 min-h-[420px] flex-1 p-4 pt-0 lg:absolute lg:inset-0 lg:min-h-0 lg:p-4">
